            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-[1fr_400px] gap-16">
                        <div>
                            <h2 className="text-sm font-bold tracking-widest text-[#8846CF] uppercase mb-4">Project Overview</h2>
                        ...
                        <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 h-fit">
                            <h3 className="text-lg font-bold text-slate-900 mb-6 flex items-center gap-2">
                                <Layers size={20} className="text-[#8846CF]" /> Technical Scope
                            </h3>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {relatedProjects.map(p => (
                            <Link to={`/projects/architecture/${p.slug}`} key={p.id} className="group block">
                                ...
                                <h3 className="text-xl font-bold mb-1 group-hover:text-[#8846CF] transition-colors">{p.title}</h3>
