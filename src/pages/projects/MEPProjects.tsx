            ...
            <main className="pt-24 pb-20">
                ...
                <section className="container mx-auto px-6 mb-16">
                    <motion.div
                        ...
                        className="max-w-3xl"
                    >
                        <motion.div variants={fadeInUpVariants} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-widest mb-6 border border-emerald-100">
                            Portfolio
                        </motion.div>
